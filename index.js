...
async function run() {
    try {
        ...
        const users = client.db('Scholars').collection('users');
        const cart = client.db('Scholars').collection('cart');
        const Course = client.db('Scholars').collection('Course');
